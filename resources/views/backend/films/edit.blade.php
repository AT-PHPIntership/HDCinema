...
@section('title', trans('lang_admin.film.title_edit_film'))

@section('content')
<!-- Page Heading -->
<section class="content-header">
        <h1>
          {{ trans('lang_admin.film.edit_film') }}
        </h1>
        <ol class="breadcrumb">
          ...
          <li class="active">{{ trans('lang_admin.film.edit_film') }}</li>
        </ol>
</section>
    <!-- /.row -->
    ...
    <div class="row" >
        <div id="form_edit" class="col col-lg-6 col-lg-offset-3"> 
            {!! Form::model($film,['route' => ['admin.film.update',$film-> id], 'method' => 'PATCH', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class = "form-group {!!$errors->has('image') ? ' has-error' : '' !!}">
                ...
                @else
                    <img class="user-image" id ="image_no" src="{{ url(config('path.upload_film').$film->image) }}">
                @endif
                @if($errors->has('image'))
            ...
            <div class = "form-group">
                {!! Form::label('admin', trans('lang_admin.film.admin').$film->admins->username, ['class' =>'control-label']) !!} <br>
